...
export default function Choosing() {
  ...
  return (
    <Layout
      pageTitle="CIWT Choosing Your Career Path"
      header="Welding School in Columbia, MO and the surrounding areas"
      bgImage="/images/ciwt_photos/5-2880w.jpg"
    >
      <Page sections={sections} review={review} />
    </Layout>
  );
}
