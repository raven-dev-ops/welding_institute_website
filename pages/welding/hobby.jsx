    ...
    <Layout pageTitle="CIWT - Hobby Welding Courses">
      <div className="max-w-5xl mx-auto px-4 py-16 space-y-6">
        ...
        <ul className="list-disc ml-6 space-y-2">
          <li><strong>Metal art:</strong> Sculptures, wall art, decorative pieces, or functional items like candleholders and coat hooks to personalize your home.</li>
          <li><strong>Furniture making:</strong> Build custom metal furniture like tables, chairs, or shelving that combine form and function.</li>
          <li><strong>Repairs and custom parts:</strong> Weld metal to repair household items or create custom parts for vehicles, tools, or equipment.</li>
        </ul>

        <p className="text-base text-gray-700">
          No matter your skill level, our hobby welding classes in Springfield, MO, will help you bring these creative projects to life!
        </p>

        <p className="text-base text-gray-700">
          Contact us today for a free tour! We return all calls and emails on the same day.
          Free parking is available for your convenience.
          Come check us out and learn why we provide the most sought-after welding classes in Springfield, MO and the surrounding areas.
        </p>

        <h2 className="text-2xl font-bold">Welding for the Hobbyist - 8 Hour Program</h2>

        <p>
          <strong>Course Description:</strong> This class is designed to teach safety and very basic oxy-fuel cutting and brazing, Shielded Metal Arc Welding (E-6013),
          Gas Metal Arc Welding on sheet metal, and any other welding processes you need to learn.
        </p>
